...
def sample_tag(user, name='Main course'):
    """Create and return test tag"""
    return Tag.objects.create(user=user, name=name)


def sample_ingredient(user, name='Main ingredient'):
    """Create and return test ingredient"""
    return Ingredient.objects.create(user=user, name=name)


def sample_recipe(user, **params):
    """Create and return test recipe"""
    defaults = {
        'title': 'Sample recipe',
        'time_minutes': 10,
        'price': 50
...
class PrivateRecipeAPiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        """Test creating recipe view tags"""
    ...
    def test_filter_recipes_by_tags(self):
        """Test filtering recipes by tag ids"""
        recipe1 = sample_recipe(user=self.user, title='Curry recipe')
        recipe2 = sample_recipe(user=self.user, title='Tahini')
        tag1 = sample_tag(user=self.user, name='Test tag 1')
